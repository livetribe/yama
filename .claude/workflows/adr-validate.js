...
const DIMENSIONS = [
  {
    key: 'ste',
    prompt: `${ROOT_NOTE} Read the ADR in full. Load the "ste100" skill (Skill tool, skill name "ste100") and apply its full checklist, including its "read it again as a reader" step, to the whole document. Report every real violation: chained clauses via semicolon/colon/and/but, em dashes as clause connectors, a colon introducing a clause instead of a list, metaphor or idiom, stacked/elided relative clauses, sentences over ~25 words, dropped quantifier or modal scope, inconsistent terminology, passive voice with no actor, and anything else the checklist covers. Only report things you are genuinely confident are real violations after applying the checklist properly, not stylistic nitpicks. Tag every finding gate: "Style". For each, give the summary, exact location, a short quote, and why it matters for a reader.`,
  },
  {
    key: 'provenance',
